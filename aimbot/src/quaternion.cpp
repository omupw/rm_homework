...
Quaternion Quaternion::fromEulerZYX(double yaw, double pitch, double roll) {
...
cv::Vec3d Quaternion::toEulerZYX(const Quaternion &q) {
...
cv::Vec3d Quaternion::rotateVector(const cv::Vec3d &v, const Quaternion &rot) {
